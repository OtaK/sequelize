...
var TEXT = function() {
  return TEXT.prototype.construct.apply(this, [TEXT].concat(Array.prototype.slice.apply(arguments)));
};
...
BLOB.toString = TEXT.toString = STRING.toString = CHAR.toString = INTEGER.toString = FLOAT.toString = BIGINT.toString = DECIMAL.toString = function() {
...
TEXT.prototype = {
  ...
  construct: BLOB.prototype.construct,

  get type() {
    return this.toString();
  },

  // Fallback for TEXT on all platforms
  toString: function() {
    return 'TEXT'; // Should return TEXT
  }
...
Object.defineProperty(TEXT, 'type', typeDesc);
...
module.exports = {
  ...
  CHAR: CHAR,
  /**
   * An unlimited length text column - Available lengths: `tiny`, `medium`, `long` on MySQL
   * @property TEXT
   */
  TEXT: TEXT,
  /**
